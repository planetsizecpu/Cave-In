...
To run it just download/unpack the files & folders and click on cave.red file if you have Red language toolchain in your path, otherwise click on cave.exe
