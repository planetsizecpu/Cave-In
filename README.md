...
This was an arcade machine game from the early 80's, (I don't remember the manufacturer name, but we recognize any copyright if apply) where I spent a lot of coins.
Now that I'm learning Red language, I thought it was a good idea to try to imitate the game, just to learn while having fun.
