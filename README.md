...
To run the game you need the [Red](https://www.red-lang.org/p/download.html) toolchain in your path, just download/unpack the files & folders and click on cave.red file (yes it runs on interpreter, that's how powerful Red-lang is), otherwise, you can compile your exe with `red -r -t [target OS]` or if you trust me, click on cave executable file (not tested on Mac). Meet us at the Red [forums](https://gitter.im/red/red/gui-branch)
